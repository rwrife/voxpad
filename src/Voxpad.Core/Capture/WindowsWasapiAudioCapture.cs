...
public sealed class WindowsWasapiAudioCapture : IAudioCapture
{
    private const int WhisperSampleRateHz = DecodedAudioPcm.WhisperSampleRateHz;

    private readonly string ffmpegPath;
    private readonly string dshowInput;
    ...
    public WindowsWasapiAudioCapture(string ffmpegPath = "ffmpeg", string dshowInput = "audio=default")
    {
        this.ffmpegPath = ffmpegPath;
        this.dshowInput = dshowInput;
    }
    ...
    public Task StartAsync(Func<AudioLevelSample, ValueTask>? onLevelSample = null, CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new PlatformNotSupportedException("WindowsWasapiAudioCapture is only supported on Windows.");
        }
        ...
        startInfo.ArgumentList.Add(dshowInput);
    ...
    public async Task<DecodedAudioPcm> StopAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            {
                throw new InvalidOperationException($"No audio samples were captured from dshow input '{dshowInput}'. ffmpeg stderr: {stderr}");
            }
